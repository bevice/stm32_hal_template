...
SET(CMAKE_C_FLAGS "-isystem ${TOOLCHAIN_INC_DIR} -mthumb -mcpu=cortex-m3 -fno-builtin -Wall  -ffunction-sections -fdata-sections -mfloat-abi=soft -std=gnu99 ${EXTRA_FLAGS_SEMIHOSTING}" CACHE INTERNAL "c compiler flags")
SET(CMAKE_CXX_FLAGS "-isystem ${TOOLCHAIN_INC_DIR} -mthumb -mcpu=cortex-m3 -fno-builtin -Wall " CACHE INTERNAL "cxx compiler flags")
SET(CMAKE_EXE_LINKER_FLAGS "--specs=nano.specs -nostartfiles -Wl,-Map -Wl,main.map -mthumb -mcpu=cortex-m3 -Wl,--gc-sections" CACHE INTERNAL "exe link flags")
